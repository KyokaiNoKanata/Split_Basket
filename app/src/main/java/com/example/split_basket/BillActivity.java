...
public class BillActivity extends AppCompatActivity {
    ...
    private void loadBillsFromStorage() {
        try {
            billItems = billStorage.getAllBills();
    ...
    private void createNewBill() {
        ...
        try {
            ...
            if (radioEqual.isChecked()) {
                ...
                // 创建新账单对象
                String billId = "new_bill_" + System.currentTimeMillis();
                BillItem newBill = new BillItem(billId, name, String.format("%.2f", totalAmount), "Unpaid", mode, creationDate);
    ...
    private void hideStaticBillCards() {
        ...
        if (cardUnpaidBill != null) cardUnpaidBill.setVisibility(View.GONE);
        if (cardPaidBill1 != null) cardPaidBill1.setVisibility(View.GONE);
        if (cardPaidBill2 != null) cardPaidBill2.setVisibility(View.GONE);
    }
